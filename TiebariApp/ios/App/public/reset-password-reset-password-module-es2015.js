...
let ResetPasswordPage = class ResetPasswordPage {
    constructor(authService, alertCtrl, formBuilder, router) {
    ...
    resetPassword(resetPasswordForm) {
        if (!resetPasswordForm.valid) {
            ...
            this.authService.resetPassword(email).then(() => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
