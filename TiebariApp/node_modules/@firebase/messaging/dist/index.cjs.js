...
function toBase64(arrayBuffer) {
    ...
    return btoa(String.fromCharCode.apply(String, tslib.__spread(uint8Version)));
}
...
var TokenDetailsModel = /** @class */ (function (_super) {
    tslib.__extends(TokenDetailsModel, _super);
            ...
            case 2: {
                ...
                cursorRequest_1.onsuccess = function () {
                    ...
                    if (cursor) {
                        ...
                        var newValue = tslib.__assign({}, value);
                        if (!value.createTime) {
...
var VapidDetailsModel = /** @class */ (function (_super) {
    tslib.__extends(VapidDetailsModel, _super);
...
var SwController = /** @class */ (function (_super) {
    tslib.__extends(SwController, _super);
    ...
    SwController.prototype.getNotificationData_ = function (msgPayload) {
        ...
        var notificationInformation = tslib.__assign({}, msgPayload.notification);
        // Put the message payload under FCM_MSG name so we can identify the
        // notification as being an FCM notification vs a notification from
        // somewhere else (i.e. normal web push or developer generated
        // notification).
        notificationInformation.data = tslib.__assign(tslib.__assign({}, msgPayload.notification.data), (_a = {}, _a[FCM_MSG] = msgPayload, _a));
...
var WindowController = /** @class */ (function (_super) {
    tslib.__extends(WindowController, _super);
    /**
    ...
    WindowController.prototype.setupSWMessageListener_ = function () {
        var _this = this;
        navigator.serviceWorker.addEventListener('message', function (event) { return tslib.__awaiter(_this, void 0, void 0, function () {
...
function registerMessaging(instance) {
    ...
    instance.INTERNAL.registerComponent(new component.Component(messagingName, factoryMethod, "PUBLIC" /* PUBLIC */).setServiceProps(namespaceExports));
