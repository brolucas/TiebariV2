...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function node_modulesFirebaseFirestoreDistIndexEsmJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _firebase_firestore__WEBPACK_IMPORTED_MODULE_0___default =
    /*#__PURE__*/
    __webpack_require__.n(_firebase_firestore__WEBPACK_IMPORTED_MODULE_0__); //# sourceMappingURL=index.esm.js.map
    ...
    function () {
      ...
      _createClass(AuthService, [{
        ...
        value: function signupUser(email, password) {
          return firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"]().createUserWithEmailAndPassword(email, password).then(function (newUserCredential) {
            firebase_app__WEBPACK_IMPORTED_MODULE_2__["firestore"]().doc("/userProfile/".concat(newUserCredential.user.uid)).set({
              email: email
            });
